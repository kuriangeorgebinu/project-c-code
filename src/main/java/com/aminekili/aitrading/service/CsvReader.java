...
public class CsvReader {
    ...
    public static StructType schema = DataTypes.struct(
            ...
            new StructField("Day", DataTypes.DoubleType),
            new StructField("Month", DataTypes.DoubleType),
            ...
            new StructField("Value5", DataTypes.DoubleType),
            new StructField("Value6", DataTypes.DoubleType),
