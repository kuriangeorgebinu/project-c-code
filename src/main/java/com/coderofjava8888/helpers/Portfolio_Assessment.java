package com.coderofjava8888.helpers;
...
//        criteria_Match.put("EUR", Arrays.asList(-1.89, 2.0));
        ...
        criteria_Match.put("AUD", Arrays.asList(-100.00, 100.00));
        criteria_Match.put("JPY", Arrays.asList(-100.00, 100.00));
        criteria_Match.put("CHF", Arrays.asList(-100.00, 100.00));
        criteria_Match.put("GBP", Arrays.asList(-100.00, 100.00));
        criteria_Match.put("EUR", Arrays.asList(-100.00, 100.00));
        criteria_Match.put("CAD", Arrays.asList(-100.00, 100.00));
        criteria_Match.put("MXP", Arrays.asList(-100.00, 100.00));

//        criteria_Match.put("AUD", Arrays.asList(-56.60, 56.60));
//        criteria_Match.put("JPY", Arrays.asList(-56.60, 56.60));
//        criteria_Match.put("CHF", Arrays.asList(-56.60, 56.60));
//        criteria_Match.put("GBP", Arrays.asList(-56.60, 56.60));
//        criteria_Match.put("EUR", Arrays.asList(-56.60, 56.60));
//        criteria_Match.put("CAD", Arrays.asList(-56.60, 56.60));
//        criteria_Match.put("MXP", Arrays.asList(-56.60, 56.60));
