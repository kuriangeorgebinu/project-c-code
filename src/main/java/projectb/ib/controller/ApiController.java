...
package projectb.ib.controller;

import projectb.ib.client.*;
import projectb.ib.client.Types.*;
import projectb.ib.controller.ApiConnection.ILogger;
...
public class ApiController implements EWrapper {
	...
	@Override public void historicalData(int reqId, projectb.ib.client.Bar bar) {
    ...
    @Override
    public void historicalDataUpdate(int reqId, projectb.ib.client.Bar bar) {
